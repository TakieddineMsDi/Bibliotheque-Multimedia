...
public class AddAuteurForLivre extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AddAuteurForLivre(final Model auteur) {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(auteur != null){
					if(AuteurJCB.getSelectedItem() != null){
							int x = new Est_Ecrit(auteur.get(), ((Model)AuteurJCB.getSelectedItem()).get()).add();
							if(x == 1){
		...
		Object[] items = new Auteur().getArray();
