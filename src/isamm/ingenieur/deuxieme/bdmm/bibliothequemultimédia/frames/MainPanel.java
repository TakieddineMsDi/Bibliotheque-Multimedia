...
public final class MainPanel extends JPanel {
	...
	private JTable makeTable() {
		...
		String[] columnNames = Entity.getFieldsToShow();
		Object[][] data = Entity.getPreparedDataToshow();
...
class ButtonsPanel extends JPanel {
	public final List<JButton> buttons = Arrays.asList(new JButton("edit"),new JButton("delete"));
...
class ButtonsEditor extends ButtonsPanel implements TableCellEditor {
	...
	private class EditingStopHandler extends MouseAdapter implements
			ActionListener {
		@Override
